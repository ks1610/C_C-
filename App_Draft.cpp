      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.println(".button_26{background-image: url(/img/kitchen.png);background-size: cover;background-position: center top;}");
            client.println(".button_27{background-image: url(/img/livingroom.png);background-size: cover;background-position: center top;}");
            client.println(".button_25, .button_33, .button_32{background-image: url(/img/bedroom.png);background-size: cover;background-position: center top;}");
            client.println(".button_34{background-image: url(/img/garden.png);background-size: cover;background-position: center top;}");
